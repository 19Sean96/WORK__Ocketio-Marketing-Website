    ...
    <ContentWrapper width="1575px">
      ...
      >
        ...
        >
          ...
          <p className="p-lg">
            Ocketio is built with a set of core attributes that just might make it the best solution for your real-world network security needs.
          </p>
        </ScrollAnimation>
...
function WhatSectionItem({
  ...
  const ref = useRef();
  const { scrollOffset, windowInnerHeight, windowScrollY, isSafari } =
    useAppContext();
        ...
        <article className="card__wrapper f f-align-stretch f-justify-stretch f-no-wrap all-columns">
          ...
          >
            ...
            <div className="card--text">
              <h3 className="h3 capitalize">individual users</h3>
              <p className="p-sm">
          ...
          >
            ...
            />
            <div className="card--text">
              <h3 className="h3 capitalize">small business teams</h3>
              <p className="p-sm">
          ...
          >
            ...
            />
            <div className="card--text">
              <h3 className="h3 capitalize">mid-sized companies</h3>
              <p className="p-sm">
